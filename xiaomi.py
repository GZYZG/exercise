#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2021/01/25 19:55
# @Author  : huni
# @File    : yundong.py
# @Software: PyCharm
# 源：https://blog.csdn.net/m0_50944918/article/details/113186352
"""
用于修改维新运动的步数，修改原理：
1）用手机号注册小米运动账号，并将小米运动与微信运动绑定；
2）用手机号+密码，通过接口登录小米运动；
3） 设置运动步数，通过接口上传至小米运动；
"""
import requests
import time
import datetime
...
if __name__ == "__main__":
    ...
    while fail_num > 0:
        try:
            ...
            stepnum = 66666  # 2 * 10000 + a *1000 + b *100 + c * 10 + d *1
